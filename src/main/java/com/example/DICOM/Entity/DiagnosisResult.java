...
public class DiagnosisResult {
    ...
    @ManyToOne
    @JoinColumn(name = "analyzed_by", referencedColumnName = "userId")
    ...
    public DiagnosisResult(DicomImage image, User analyzedBy, String diagnosis, Double confidenceScore, LocalDateTime analysisDate) {
        this.image = image;
